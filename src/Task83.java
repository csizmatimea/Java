...
public class Task83 {
    ...
    public static void main(String[] args) {
        ...
        for (String vitaminConsumption :vitaminConsumptions) {
           ...
           int vitaminCValue = Integer.parseInt(values[1].split(":")[1]);
           int vitaminDValue = Integer.parseInt(values[2].split(":")[1]);
           int vitaminEValue = Integer.parseInt(values[3].split(":")[1]);

            System.out.println("Hey " + name);

           if (vitaminCValue<150){
            System.out.print( " Your C-vitamin consumption is too low!");
        }
           if (vitaminDValue<1800){
               System.out.print(" Your D-vitamin consumption is too low!");
           }
           if(vitaminEValue<3600){
